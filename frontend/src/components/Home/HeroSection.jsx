   ...
   return (
      <div className='text-center'>
         <div className='flex flex-col gap-4 my-8'>
            ...
            <h1 className='text-3xl sm:text-5xl font-bold'>Search, Apply & <br /> <span className='text-[#6A38C2]'>Dream Jobs</span></h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur et, ducimus ea doloribus.</p>
            <div className='flex sm:w-[40%] shadow-lg items-center border border-gray-200 mx-auto pl-4 rounded-md rounded-r-full '>

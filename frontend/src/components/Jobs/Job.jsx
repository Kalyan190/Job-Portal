...
const Job = ({ job }) => {
   ...
   return (
      <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100 w-72 h-[100%]'>
         ...
         <div className='flex items-center gap-2 my-2'>
            <Button className="p-6" variant="outline" size="icon"><Avatar><AvatarImage src={job?.company?.logo} /></Avatar></Button>
            <div>
         ...
         <div>
            ...
            <p className='text-sm text-gray-600 truncate'>{job?.description}</p></div>
